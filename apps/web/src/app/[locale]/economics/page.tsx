...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'כל הצבעה מקבלת BAG משלה ב-bags.fm — מטבע ממים מבוסס בלוקצ׳יין שמאפשר לכל אחד להשקיע בתנועה הכלכלית של הנושא ולתמוך בביצוע ההחלטה. שקיפות מלאה, כל עסקה גלויה.',
    type: 'website',
  },
};
