...
const steps = [
  ...
  {
    number: '03',
    title: 'הצביעו ותרמו ₪3',
    description:
      'בחרו את האפשרות המועדפת עליכם, אמתו את מיקומכם באמצעות GPS, ותרמו ₪3. הכסף הולך לאכיפה כשהרשות מסרבת להתיישר עם הרוב.',
    details: [
      'אימות GPS בזמן אמת',
      'תשלום מאובטח',
      'הכסף הולך לצעדים משפטיים ותקשורתיים',
    ],
  },
  {
    number: '04',
