...
const getFeatures = (locale: Locale) => [
  ...
  },
  {
    ...
    description: locale === 'en'
      ? 'Every ₪3 participation fee accrues in the vote\'s own community pool, recorded in an open ledger. When the vote resolves, the pool seeds the community\'s Issue Coin — every shekel traceable from payment to impact.'
      : 'כל ₪3 של דמי השתתפות נצברים בקופה הייעודית של ההצבעה, ברישום פתוח ושקוף. בסיום ההצבעה הקופה זורעת את מטבע הקהילה (Issue Coin) — כל שקל ניתן למעקב מהתשלום ועד ההשפעה.',
  },
];
